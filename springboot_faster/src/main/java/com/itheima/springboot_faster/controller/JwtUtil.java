...
import com.itheima.springboot_faster.domain.animal;
...
public class JwtUtil {
    ...
    public SecretKey generalKey() {
        String stringKey = "123456";     // 本地的密码解码
        byte[] encodedKey = Base64.decodeBase64(stringKey); // 根据给定的字节数组使用AES加密算法构造一个密钥
    ...
    public static void main(String[] args) {
        try {
            ...
            String jwt = util.createJWT( UUID.randomUUID().toString(), "Anson", "hjd", 60*60*1000);
